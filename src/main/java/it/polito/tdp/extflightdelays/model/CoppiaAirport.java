...
public class CoppiaAirport {
	...
	private Airport a1;
	private Airport a2;
	private Integer avgDistanza;

	public CoppiaAirport(Airport a1, Airport a2, Integer avgDistanza) {
		super();
		this.a1 = a1;
		this.a2 = a2;
	...
	public Integer getAvgDistanza() {
		return avgDistanza;
	}

	public void setAvgDistanza(Integer avgDistanza) {
		this.avgDistanza = avgDistanza;
	}
